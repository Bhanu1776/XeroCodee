...
const Testimonials = () => {
  ...
  <section className='lg:flex hidden flex-col items-center mt-20 mb-16 mx-32'>
      ...
      <div className='flex '>
          <Image loading="lazy"
 src="/Assets/leftArrow.png" className='py-20 px-3' alt="Arrows" height={1000} width={100} />
          <article className='flex items-center rounded-r-3xl max-w-[60rem]'>
            <Image loading="lazy"
 src="/Assets/comma.png" alt="Arrows" height={30} width={150} />
          ...
          <Image loading="lazy"
 src="/Assets/rightArrow.png" className='py-20 px-3' alt="Arrows" height={1000} width={100} />
      </div>
          <Image loading="lazy"
 src="/Assets/threedots.png" alt="Arrows" height={20} width={60} />
  </section>
  )
}

...
<footer className="bg-white lg:ml-40  p-4">
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            <h2 className="mb-6 text-sm text-gray-900 uppercase font-bold ">Our Links</h2>
            <ul className="text-gray-500  font-medium">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase ">Our Services</h2>
            <ul className="text-gray-500  font-medium">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">Other Links</h2>
            <ul className="text-gray-500  font-medium">
                <li className="mb-4">
    ...
    <div className="px-2 lg:pr-40 py-6 md:flex md:items-center md:justify-between">
        <span className="text-gray-500 sm:text-center">Terms & Condition | Privacy Policy
        </span>
        <br className='block md:hidden' />
        <span>
          Copyright © 2023 <span className='font-bold'>EXOCODE TECHNOLOGIES</span> | All rights reserved
        </span>
      </div>
    </div>
</footer>

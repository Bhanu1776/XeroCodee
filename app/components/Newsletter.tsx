...
const Newsletter = () => {
  return (
    <main className='bg-blue-200 items-center pb-20 mb-40 rounded-[2rem] mx-6 lg:mx-40 3xl:mx-[35rem] flex flex-col'>
        <Image loading="lazy"
 src="/Assets/airplane.png" className='mt-20' alt="airplane" height={100} width={120} />
